...
$success_url = site_url('payment/doniapay?uid='.$user['client_id'].'&txnid='.$txnid);
...
<div class="dimmer-content">
    ...
    <form action="' . $payment_url . '" method="get" name="doniapayForm" id="doniapayForm">
        <script type="text/javascript">
            document.getElementById("doniapayForm").submit();
        </script>
    </form>
</div>
</div>';
